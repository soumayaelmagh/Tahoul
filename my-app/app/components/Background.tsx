export default function Background() {
  ...
  return (
    <div className="pointer-events-none fixed inset-0 z-0">
      ...
      <div className="glow-orb absolute left-10 top-24 h-56 w-56 opacity-70" />
      <div className="glow-orb blue absolute right-24 top-10 h-64 w-64 opacity-60" />
      <div className="glow-orb deep absolute bottom-16 left-1/3 h-72 w-72 opacity-50" />
